...
@app.post("/api/pro/projects/{song_id}/instrumental")
def generate_professional_instrumental(song_id: str) -> dict[str, Any]:
    return run_action(lambda: service.generate_professional_instrumental(song_id))


@app.get("/api/pro/projects/{song_id}/instrumental")
def get_professional_instrumental(song_id: str) -> dict[str, Any]:
    return run_action(lambda: service.get_professional_instrumental(song_id))


@app.post("/api/pro/projects/{song_id}/vocals")
def generate_professional_vocals(song_id: str) -> dict[str, Any]:
    return run_action(lambda: service.generate_professional_vocals(song_id))


@app.get("/api/pro/projects/{song_id}/vocals")
def get_professional_vocals(song_id: str) -> dict[str, Any]:
    return run_action(lambda: service.get_professional_vocals(song_id))


@app.post("/api/pro/projects/{song_id}/voice-conversion")
def convert_professional_voice(song_id: str) -> dict[str, Any]:
    return run_action(lambda: service.convert_professional_voice(song_id))


@app.get("/api/pro/projects/{song_id}/voice-conversion")
def get_professional_converted_voice(song_id: str) -> dict[str, Any]:
    return run_action(lambda: service.get_professional_converted_voice(song_id))


@app.post("/api/pro/projects/{song_id}/mix")
def mix_professional_song(song_id: str) -> dict[str, Any]:
    return run_action(lambda: service.mix_professional_song(song_id))


@app.get("/api/pro/projects/{song_id}/mix")
def get_professional_mix(song_id: str) -> dict[str, Any]:
