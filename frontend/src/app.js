  ...
  data() {
    return {
      ...
      instrumental: {
        ...
        bpm: 96,
        key: "C major",
        instruments: ["piano", "soft drums", "electric bass"],
        energy: "medium",
      },
      melody: {
      ...
      projectSet: {
        ...
        description: "Proyecto musical creado desde el flujo guiado.",
      },
      drafts: [],
      sets: [],
      selectedSet: null,
  ...
  computed: {
    ...
    productionSteps() {
      return [
        ...
        { label: "2. Crear sample", hint: "Genera una vista previa desde el set.", url: "/api/samples" },
        { label: "3. Crear cancion", hint: "Crea la estructura de cancion completa mock.", url: "/api/songs" },
        { label: "4. Preparar mezcla", hint: "Prepara carpeta mix y verifica ffmpeg.", url: "/api/mix" },
